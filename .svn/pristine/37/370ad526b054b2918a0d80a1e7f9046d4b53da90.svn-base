...
<div class="row">
	<div class="col-xs-12">
		<!-- PAGE CONTENT BEGINS -->
		<form class="form-horizontal data-form" role="form" action="${pageContext.request.contextPath}/vmanage/appVersionManage/add/exec" method="post" enctype="multipart/form-data" valid="true" >
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
					<div class="clearfix">
						<input type="text" placeholder="版本号" class="col-xs-10 col-sm-5" id="versionNumber" name="versionNumber"/>
					</div>
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
					<div class="clearfix">
						<textarea id="updateLog" name="updateLog" class="autosize-transition col-xs-10 col-sm-5"></textarea>
					</div>
				</div>
			</div>
