...
<div class="row">
	<div class="col-xs-12">
		<!-- PAGE CONTENT BEGINS -->
		<form class="form-horizontal data-form" role="form" valid = "true" action="${pageContext.request.contextPath}/vmanage/userManage/add/exec">
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
					<div class="clearfix">
						<input type="text" id="username" placeholder="用户名" class="col-xs-10 col-sm-5" name="username" />
					</div>
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
					<div class="clearfix">
						<input type="password" id="password" placeholder="密码" class="col-xs-10 col-sm-5" name="password" />
					</div>
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
					<div class="clearfix">
						<input type="password" id="password2" placeholder="二次密码" class="col-xs-10 col-sm-5" name="password2" />
					</div>
				</div>
			</div>
