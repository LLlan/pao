 ...
 * 
 */
@Controller("vhousekeepingLoginController")
@RequestMapping(value = "/vhousekeeping/loginManage")
public class LoginController {
    ...
    public ModelAndView goLogin(ModelAndView view) {
        view.setViewName("vhousekeeping.login");
        return view;
    }
    ...
    public ModelAndView index(ModelAndView view) {
        view.setViewName("vhousekeeping.index");
        return view;
    }
