...
<div class="row">
	<div class="col-xs-12">
		<!-- PAGE CONTENT BEGINS -->
		<form class="form-horizontal data-form" enctype="multipart/form-data" role="form" action="${pageContext.request.contextPath}/vmanage/serviceTypeManage/serviceDescriptionManage/add/exec" method="post" valid="true">
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
					<div class="clearfix">
						<input type="text" placeholder="服务描述" class="col-xs-10 col-sm-5" id="description" name="description"/>
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
					<div class="clearfix">
						<textarea class="col-xs-10 col-sm-5" placeholder="备注" id="remarks" name="remarks"></textarea>
					</div>
				</div>
			</div>
