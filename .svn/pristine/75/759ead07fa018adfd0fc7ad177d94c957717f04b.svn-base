...
<h3 class="header smaller lighter blue">新增物业费配置信息</h3>
<div class="row">
	<div class="col-xs-12">
		<!-- PAGE CONTENT BEGINS -->
		<form class="form-horizontal data-form" role="form" enctype="multipart/form-data" action="add/exec" valid = "true">
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
					<div class="clearfix">
						<input type="text" id="form-field-1" name="charge" class="col-xs-10 col-sm-5" placeholder="元/平方" />
					</div>
				</div>
			</div>
...
<script type="text/javascript">
	$(function() {
		...
		if ($("select[name='villageId.id']").val()) {
			Village.queryHouseListByVid($("select[name='villageId.id']").val());
		}
