...
%>
<!-- /.page-header -->
<h3 class="header smaller lighter blue">新增单元</h3>
<div class="row">
	<div class="col-xs-12">
		<!-- PAGE CONTENT BEGINS -->
		<form class="form-horizontal data-form" role="form" action="doPlateAdd" valid="true">
			<input type="hidden" name="houseId" value="${doorPlate.houseId }" />
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
					<div class="clearfix">
						<input type="text" id="form-field-1" name="doorName" class="col-xs-10 col-sm-5" />
					</div>
				</div>
			</div>
