...
<h3 class="header smaller lighter blue">新增公告类型</h3>
<div class="row">
	<div class="col-xs-12">
		<!-- PAGE CONTENT BEGINS -->
		<form class="form-horizontal data-form" role="form" action="add/exec" valid = "true">
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
					<div class="clearfix">
						<input type="text" id="form-field-1" name="typeName" class="col-xs-10 col-sm-5" />
					</div>
				</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
					<label class="checkbox-inline">
				      <input type="radio" name="useFlag" value="YES" checked="checked"> 是
				    </label>
				    <label class="checkbox-inline">
				      <input type="radio" name="useFlag" value="NO"> 否
				    </label>
				</div>
			</div>
