...
<h3 class="header smaller lighter blue">新增楼栋</h3>
<div class="row">
	<div class="col-xs-12">
		<!-- PAGE CONTENT BEGINS -->
		<form class="form-horizontal data-form" role="form" action="doHouseAdd" valid="true">
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
					<input type="text" id="form-field-1" name="remark" class="col-xs-10 col-sm-5" />
				</div>
			</div>
