...
<h3 class="header smaller lighter blue">新增住户信息</h3>
<div class="row">
	<div class="col-xs-12">
		<!-- PAGE CONTENT BEGINS -->
		<form class="form-horizontal data-form" role="form" valid="true" action="doTenementAdd" >
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
					<div class="clearfix">
						<input type="text" name="houseNumber" class="col-xs-10 col-sm-5" />
					</div>
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
					<input type="text" name="acreage" class="col-xs-10 col-sm-5" />
				</div>
			</div>
