...
<div class="row">
	<div class="col-xs-12">
		<!-- PAGE CONTENT BEGINS -->
		<form class="form-horizontal data-form" enctype="multipart/form-data" role="form" action="${pageContext.request.contextPath}/vhousekeeping/homemakingServiceManage/add/exec" method="post" valid="true">
			...
			<div class="form-group">
				...
				<c:forEach var="item" items="${serviceTypeList}" varStatus="vs">
