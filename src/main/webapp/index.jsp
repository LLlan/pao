...
<![endif]-->
		...
		<script src="${pageContext.request.contextPath}/assets/js/flot/jquery.flot.js"></script>
		<script src="${pageContext.request.contextPath}/assets/js/flot/jquery.flot.pie.js"></script>
		<script src="${pageContext.request.contextPath}/assets/js/flot/jquery.flot.resize.js"></script>
		...
		<script type="text/javascript"> ace.vars['base'] = '${pageContext.request.contextPath}'; </script>
		...
		<script type="text/javascript">
			var remoteData = function(options, callback) {
				...
				if(parent_id !== null) {
					$.ajax({
						url: "${pageContext.request.contextPath}/vmanage/core/loginManage/test",
						data: 'id='+parent_id,
						type: 'POST',
						dataType: 'json',
